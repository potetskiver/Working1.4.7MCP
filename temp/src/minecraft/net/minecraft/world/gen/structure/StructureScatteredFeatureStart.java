   ...
   public StructureScatteredFeatureStart(World p_i3832_1_, Random p_i3832_2_, int p_i3832_3_, int p_i3832_4_) {
      ...
      if(var5 != BiomeGenBase.field_76782_w && var5 != BiomeGenBase.field_76792_x) {
         if(var5 == BiomeGenBase.field_76780_h) {
            ComponentScatteredFeatureSwampHut var7 = new ComponentScatteredFeatureSwampHut(p_i3832_2_, p_i3832_3_ * 16, p_i3832_4_ * 16);
            this.field_75075_a.add(var7);
         } else {
            ComponentScatteredFeatureDesertPyramid var8 = new ComponentScatteredFeatureDesertPyramid(p_i3832_2_, p_i3832_3_ * 16, p_i3832_4_ * 16);
