   ...
   public void func_72467_a(Packet254ServerPing p_72467_1_) {
      try {
         ...
         if(p_72467_1_.field_82559_a == 1) {
            List var4 = Arrays.asList(new Serializable[]{Integer.valueOf(1), Integer.valueOf(51), this.field_72534_f.func_71249_w(), this.field_72534_f.func_71273_Y(), Integer.valueOf(var2.func_72394_k()), Integer.valueOf(var2.func_72352_l())});
