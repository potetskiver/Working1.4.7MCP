...
public class RenderBlocks
{
    ...
    public boolean renderBlockRepeater(Block par1Block, int par2, int par3, int par4)
    {
        ...
        var8.addVertexWithUV(var39, var49, var47, var54, var27);
        var8.addVertexWithUV(var37, var49, var45, var54, var29);
        var8.addVertexWithUV(var35, var49, var43, var55, var29);
        var8.addVertexWithUV(var33, var49, var41, var55, var27);
        return true;
    }
    ...
    public boolean renderBlockPane(BlockPane par1BlockPane, int par2, int par3, int par4)
    {
        ...
        else
        {
            ...
            var67 = par1BlockPane.getSideTextureIndex();
        }
        ...
        else
        {
            ...
            for (var34 = 0; var34 < 4; ++var34)
            {
                ...
                if (this.renderAllFaces || var12[var34])
                {
                    ...
                    var5.setBrightness(par1Block.getMixedBrightnessForBlock(this.blockAccess, var65, par3, var37));
                    float var63 = 1.0F;
