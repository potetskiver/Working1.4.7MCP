...
public class TextureCompassFX extends FMLTextureFX
{
    ...
    public static void func_82390_a(double par0, double par2, double par4, boolean par6, boolean par7)
    {
        ...
        {
            ChunkCoordinates var28 = instance.mc.theWorld.getSpawnPoint();
            double var30 = (double)var28.posX - par0;
            double var32 = (double)var28.posZ - par2;
            var27 = (par4 - 90.0D) * Math.PI / 180.0D - Math.atan2(var32, var30);
        ...
        {
            for (var29 = var27 - instance.field_76868_i; var29 < -Math.PI; var29 += (Math.PI * 2D))
            {
                ;
            }
