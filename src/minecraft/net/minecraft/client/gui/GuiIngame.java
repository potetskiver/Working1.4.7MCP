...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float par1, boolean par2, int par3, int par4)
    {
        ...
        if (this.mc.gameSettings.showDebugInfo)
        {
            ...
            this.drawString(var8, String.format("x: %.5f (%d) // c: %d (%d)", new Object[] {Double.valueOf(this.mc.thePlayer.posX), Integer.valueOf(var46), Integer.valueOf(var46 >> 4), Integer.valueOf(var46 & 15)}), 2, 64, 14737632);
            ...
            {
                Chunk var51 = this.mc.theWorld.getChunkFromBlockCoords(var46, var23);
                this.drawString(var8, "lc: " + (var51.getTopFilledSegment() + 15) + " b: " + var51.getBiomeGenForWorldCoords(var46 & 15, var23 & 15, this.mc.theWorld.getWorldChunkManager()).biomeName + " bl: " + var51.getSavedLightValue(EnumSkyBlock.Block, var46 & 15, var22, var23 & 15) + " sl: " + var51.getSavedLightValue(EnumSkyBlock.Sky, var46 & 15, var22, var23 & 15) + " rl: " + var51.getBlockLightValue(var46 & 15, var22, var23 & 15, 0), 2, 96, 14737632);
            }

            this.drawString(var8, String.format("ws: %.3f, fs: %.3f, g: %b, fl: %d", new Object[] {Float.valueOf(this.mc.thePlayer.capabilities.getWalkSpeed()), Float.valueOf(this.mc.thePlayer.capabilities.getFlySpeed()), Boolean.valueOf(this.mc.thePlayer.onGround), Integer.valueOf(this.mc.theWorld.getHeightValue(var46, var23))}), 2, 104, 14737632);
            GL11.glPopMatrix();
            this.mc.mcProfiler.endSection();
        }
        ...
        if (this.mc.gameSettings.keyBindPlayerList.pressed && (!this.mc.isIntegratedServerRunning() || this.mc.thePlayer.sendQueue.playerInfoList.size() > 1))
        {
            ...
            List var38 = var42.playerInfoList;
            var13 = var42.currentServerMaxPlayers;
            var36 = var13;
            ...
            byte var44 = 10;
            drawRect(var17 - 1, var44 - 1, var17 + var16 * var40, var44 + 9 * var36, Integer.MIN_VALUE);
            ...
            for (var19 = 0; var19 < var13; ++var19)
            {
                ...
                if (var19 < var38.size())
                {
                    ...
                    var8.drawStringWithShadow(var47.name, var20, var46, 16777215);
                    ...
                    this.zLevel += 100.0F;
                    this.drawTexturedModalRect(var20 + var16 - 12, var46, 0 + var48 * 10, 176 + var50 * 8, 10, 8);
                    this.zLevel -= 100.0F;
                }
            }
        }
